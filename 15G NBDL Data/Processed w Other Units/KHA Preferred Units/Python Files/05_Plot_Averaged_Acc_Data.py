...
plot_path = "C:\\Users\\kamezcua\\Desktop\\0000 THESIS\\Model Development\\NBDL Data\\Average Plots\\KHA Preferred Units\\Acceleration Data\\"
...
# mpl.use('TkAgg')  # or can use 'TkAgg' or Qt5Agg, whatever you have/prefer
fig,ax = plt.subplots()
ax.plot(average_df[channelt],average_df[channel_Sled_Dx_in_59], label =channel_Sled_Dx_in_59)

ax.plot(average_df[channelt],low[channel_Sled_Dx_in_59], color = "lightblue")
ax.plot(average_df[channelt],high[channel_Sled_Dx_in_59], color = "lightblue")
