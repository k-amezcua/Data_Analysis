...
average[average.columns[pd.Series(average.columns).str.contains('_m_')]] = average[average.columns[pd.Series(average.columns).str.contains('_m_')]].multiply(.001, axis='index')
average[average.columns[pd.Series(average.columns).str.contains('_m/s_')]] = average[average.columns[pd.Series(average.columns).str.contains('_m/s_')]].multiply(0.277778, axis='index')
...
df_stdev[df_stdev.columns[pd.Series(df_stdev.columns).str.contains('_m_')]] = df_stdev[df_stdev.columns[pd.Series(df_stdev.columns).str.contains('_m_')]].multiply(.001, axis='index')
df_stdev[df_stdev.columns[pd.Series(df_stdev.columns).str.contains('_m/s_')]] = df_stdev[df_stdev.columns[pd.Series(df_stdev.columns).str.contains('_m/s_')]].multiply(0.277778, axis='index')
