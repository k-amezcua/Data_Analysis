...
ax[0, 0].plot(average_df[channelt],average_df[channel_Head_Dx_ft_1], label =channel_Head_Dx_ft_1)
ax[0, 0].plot(average_df[channelt],average_df[channel_Head_Dx_ft_2], label =channel_Head_Dx_ft_2)
ax[0, 0].plot(average_df[channelt],average_df[channel_Head_Dx_ft_60], label =channel_Head_Dx_ft_60)
ax[0, 0].set_title('Head X Displacement (ft)')

ax[0, 1].plot(average_df[channelt],average_df[channel_Head_Dz_ft_5], label =channel_Head_Dz_ft_5)
ax[0, 1].plot(average_df[channelt],average_df[channel_Head_Dz_ft_6], label =channel_Head_Dz_ft_6)
ax[0, 1].plot(average_df[channelt],average_df[channel_Head_Dz_ft_62], label =channel_Head_Dz_ft_62)
ax[0, 1].set_title('Head Z Displacement (ft)')
...
ax[2, 0].plot(average_df[channelt],average_df[channel_Spine_Dx_ft_29], label =channel_Spine_Dx_ft_29)
ax[2, 0].plot(average_df[channelt],average_df[channel_Spine_Dx_ft_30], label =channel_Spine_Dx_ft_30)
ax[2, 0].plot(average_df[channelt],average_df[channel_Spine_Dx_ft_76], label =channel_Spine_Dx_ft_76)
ax[2, 0].set_title('Spine X Displacement (ft)')

ax[2, 1].plot(average_df[channelt],average_df[channel_Spine_Dz_ft_33], label =channel_Spine_Dz_ft_33)
ax[2, 1].plot(average_df[channelt],average_df[channel_Spine_Dz_ft_34], label =channel_Spine_Dz_ft_34)
ax[2, 1].plot(average_df[channelt],average_df[channel_Spine_Dz_ft_78], label =channel_Spine_Dz_ft_78)
ax[2, 1].set_title('Spine Z Displacement (ft)')
