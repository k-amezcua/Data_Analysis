...
plot_path = "C:\\Users\\kamezcua\\Desktop\\0000 THESIS\\Model Development\\NBDL Data\\Average Plots\\KHA Preferred Units - 2\\Displacement Data\\"
...
#Plot Head X Displacement (ft) - C1-2-60

# mpl.use('TkAgg')  # or can use 'TkAgg' or Qt5Agg, whatever you have/prefer
fig,ax = plt.subplots()
ax.plot(average_df[channelt],average_df[channel_Head_Dx_ft_1], label =channel_Head_Dx_ft_1)
ax.plot(average_df[channelt],average_df[channel_Head_Dx_ft_2], label =channel_Head_Dx_ft_2)
ax.plot(average_df[channelt],average_df[channel_Head_Dx_ft_60], label =channel_Head_Dx_ft_60)
...
ax.grid(True)
ax.legend()
ax.set_title('Head X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head X Displacement ft - Summary - C1-2-60.png')
plt.show()

#Plot Head X Displacement (ft) - C1-2
...
ax.set_title('Head X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head X Displacement ft - Compare - C1-2.png')
plt.show()

#Plot Head X Displacement (ft) - C1-60
...
ax.set_title('Head X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head X Displacement ft - Compare - C1-60.png')
plt.show()

#Plot Head X Displacement (ft) - C2-60
...
ax.set_title('Head X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head X Displacement ft - Compare - C2-60.png')
plt.show()

#Plot Head X Displacement (ft) - C1
...
ax.plot(average_df[channelt],low[channel_Head_Dx_ft_1],color = "lightblue")
ax.plot(average_df[channelt],high[channel_Head_Dx_ft_1],color = "lightblue")
...
ax.set_title('Head X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head X Displacement ft - C1.png')
plt.show()

#Plot Head X Displacement (ft) - C2
...
ax.plot(average_df[channelt],low[channel_Head_Dx_ft_2],color = "lightblue")
ax.plot(average_df[channelt],high[channel_Head_Dx_ft_2],color = "lightblue")
...
ax.set_title('Head X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head X Displacement ft - C2.png')
plt.show()

#Plot Head X Displacement (ft) - C60
...
ax.plot(average_df[channelt],low[channel_Head_Dx_ft_60], color = "lightblue")
ax.plot(average_df[channelt],high[channel_Head_Dx_ft_60], color = "lightblue")
...
ax.set_title('Head X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head X Displacement ft - C60.png')
plt.show()

##############################################################################################################


#Plot Head Z Displacement (ft) - C5-6-62

# mpl.use('TkAgg')  # or can use 'TkAgg' or Qt5Agg, whatever you have/prefer
fig,ax = plt.subplots()
ax.plot(average_df[channelt],average_df[channel_Head_Dz_ft_5], label =channel_Head_Dz_ft_5)
ax.plot(average_df[channelt],average_df[channel_Head_Dz_ft_6], label =channel_Head_Dz_ft_6)
ax.plot(average_df[channelt],average_df[channel_Head_Dz_ft_62], label =channel_Head_Dz_ft_62)
...
ax.grid(True)
ax.legend()
ax.set_title('Head Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head Z Displacement ft - Summary - C5-6-62.png')
plt.show()

#Plot Head Z Displacement (ft) - C5-6
...
ax.set_title('Head Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head Z Displacement ft - Compare - C5-6.png')
plt.show()

#Plot Head Z Displacement (ft) - C5-62
...
ax.set_title('Head Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head Z Displacement ft - Compare - C5-62.png')
plt.show()

#Plot Head Z Displacement (ft) - C6-62
...
ax.set_title('Head Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head Z Displacement ft - Compare - C6-62.png')
plt.show()

#Plot Head Z Displacement (ft) - C5
...
ax.plot(average_df[channelt],low[channel_Head_Dz_ft_5], color = "lightblue")
ax.plot(average_df[channelt],high[channel_Head_Dz_ft_5], color = "lightblue")
...
ax.set_title('Head Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head Z Displacement ft - C5.png')
plt.show()

#Plot Head Z Displacement (ft) - C6
...
ax.plot(average_df[channelt],low[channel_Head_Dz_ft_6], color = "lightblue")
ax.plot(average_df[channelt],high[channel_Head_Dz_ft_6], color = "lightblue")
...
ax.set_title('Head Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head Z Displacement ft - C6.png')
plt.show()

#Plot Head Z Displacement (ft) - C62
...
ax.plot(average_df[channelt],low[channel_Head_Dz_ft_62], color = "lightblue")
ax.plot(average_df[channelt],high[channel_Head_Dz_ft_62], color = "lightblue")
...
ax.set_title('Head Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Head Z Displacement ft - C62.png')
plt.show()

##############################################################################################################
##############################################################################################################

#Plot Spine X Displacement (ft) - C29-30-76

# mpl.use('TkAgg')  # or can use 'TkAgg' or Qt5Agg, whatever you have/prefer
fig,ax = plt.subplots()
ax.plot(average_df[channelt],average_df[channel_Spine_Dx_ft_29], label =channel_Spine_Dx_ft_29)
ax.plot(average_df[channelt],average_df[channel_Spine_Dx_ft_30], label =channel_Spine_Dx_ft_30)
ax.plot(average_df[channelt],average_df[channel_Spine_Dx_ft_76], label =channel_Spine_Dx_ft_76)
...
ax.grid(True)
ax.legend()
ax.set_title('Spine X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine X Displacement ft - Summary - C29-30-76.png')
plt.show()

#Plot Spine X Displacement (ft) - C29-30
...
ax.set_title('Spine X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine X Displacement ft - Compare - C29-30.png')
plt.show()

#Plot Spine X Displacement (ft) - C29-76
...
ax.set_title('Spine X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine X Displacement ft - Compare - C29-76.png')
plt.show()

#Plot Spine X Displacement (ft) - C30-76
...
ax.set_title('Spine X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine X Displacement ft - Compare - C30-76.png')
plt.show()

#Plot Spine X Displacement (ft) - C29
...
ax.plot(average_df[channelt],low[channel_Spine_Dx_ft_29], color = "lightblue")
ax.plot(average_df[channelt],high[channel_Spine_Dx_ft_29], color = "lightblue")
...
ax.set_title('Spine X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine X Displacement ft - C29')
plt.show()

#Plot Spine X Displacement (ft) - C30
...
ax.plot(average_df[channelt],low[channel_Spine_Dx_ft_30], color = "lightblue")
ax.plot(average_df[channelt],high[channel_Spine_Dx_ft_30], color = "lightblue")
...
ax.set_title('Spine X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine X Displacement ft - C30.png')
plt.show()

#Plot Spine X Displacement (ft) - C76
...
ax.plot(average_df[channelt],low[channel_Spine_Dx_ft_76], color = "lightblue")
ax.plot(average_df[channelt],high[channel_Spine_Dx_ft_76], color = "lightblue")
...
ax.set_title('Spine X Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine X Displacement ft - C76.png')
plt.show()

##############################################################################################################


#Plot Spine Z Displacement (ft) - C33-34-78

# mpl.use('TkAgg')  # or can use 'TkAgg' or Qt5Agg, whatever you have/prefer
fig,ax = plt.subplots()
ax.plot(average_df[channelt],average_df[channel_Spine_Dz_ft_33], label =channel_Spine_Dz_ft_33)
ax.plot(average_df[channelt],average_df[channel_Spine_Dz_ft_34], label =channel_Spine_Dz_ft_34)
ax.plot(average_df[channelt],average_df[channel_Spine_Dz_ft_78], label =channel_Spine_Dz_ft_78)
...
ax.grid(True)
ax.legend()
ax.set_title('Spine Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine Z Displacement ft - Summary - C33-34-78.png')
plt.show()

#Plot Spine Z Displacement (ft) - C33-34
...
ax.set_title('Spine Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine Z Displacement ft - Compare - C33-34.png')
plt.show()

#Plot Spine Z Displacement (ft) - C33-78
...
ax.set_title('Spine Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine Z Displacement ft - Compare - C33-78.png')
plt.show()

#Plot Spine Z Displacement (ft) - C34-78
...
ax.set_title('Spine Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine Z Displacement ft - Compare - C34-78.png')
plt.show()

#Plot Spine Z Displacement (ft) - C33
...
ax.plot(average_df[channelt],low[channel_Spine_Dz_ft_33], color = "lightblue")
ax.plot(average_df[channelt],high[channel_Spine_Dz_ft_33], color = "lightblue")
...
ax.set_title('Spine Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine Z Displacement ft - C33.png')
plt.show()

#Plot Spine Z Displacement (ft) - C34
...
ax.plot(average_df[channelt],low[channel_Spine_Dz_ft_34], color = "lightblue")
ax.plot(average_df[channelt],high[channel_Spine_Dz_ft_34], color = "lightblue")
...
ax.set_title('Spine Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine Z Displacement ft - C34.png')
plt.show()

#Plot Spine Z Displacement (ft) - C78
...
ax.plot(average_df[channelt],low[channel_Spine_Dz_ft_78], color = "lightblue")
ax.plot(average_df[channelt],high[channel_Spine_Dz_ft_78], color = "lightblue")
...
ax.set_title('Spine Z Displacement (ft)')
plt.subplots_adjust(left = 0.17, bottom = 0.13)
plt.savefig('Spine Z Displacement ft - C78.png')
plt.show()
