...
average[average.columns[pd.Series(average.columns).str.contains('_ft_')]] = average[average.columns[pd.Series(average.columns).str.contains('_ft_')]].multiply(0.00328084, axis='index')
...
df_stdev[df_stdev.columns[pd.Series(df_stdev.columns).str.contains('_ft_')]] = df_stdev[df_stdev.columns[pd.Series(df_stdev.columns).str.contains('_ft_')]].multiply(0.00328084, axis='index')
