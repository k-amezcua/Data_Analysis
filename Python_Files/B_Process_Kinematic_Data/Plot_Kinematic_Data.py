...
def plot_kinematic_data(data, average_data, low_data, high_data, panzer_data, thunn_data):
    ...
    average_panzer_x_df = panzer_data['average_panzer_x_df']
    average_panzer_y_df = panzer_data['average_panzer_y_df']
    average_panzer_z_df = panzer_data['average_panzer_z_df']
