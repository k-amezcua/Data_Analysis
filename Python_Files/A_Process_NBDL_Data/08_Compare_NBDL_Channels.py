...
plot_path = "C:\\Users\\kamezcua\\Desktop\\0000 THESIS\\Model Development\\NBDL Data\\Average Plots\\Original Units\\Data Comparison\\"
...
path = plot_path + filename+"_Results.csv"
results = pd.read_csv(path, sep=',', engine = 'python', index_col=False)
# average_df.drop(0, axis=1, inplace=True)
print(results)

channelsimt = 'Sim_Time_s'
channel_Head_Dy_mm = 'Head_Dy'
channel_Head_Rx_rad= 'Head_Rx'
