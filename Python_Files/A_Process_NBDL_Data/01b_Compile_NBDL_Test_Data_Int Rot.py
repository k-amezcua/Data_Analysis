...
labels_path = "C:\\Users\\kamezcua\\Desktop\\0000 THESIS\\Model Development\\NBDL Data\\Average Plots\\Original Units\\Labels\\"
...
labels = "Data Channel Labels - Original Units.txt"
userows = [0]
...
df_concat.to_excel(main_path+"v"+first_name[1:6]+" Compiled Test Data - Integrated Rotation.xlsx")
df_concat.to_csv(main_path+"v"+first_name[1:6]+" Compiled Test Data - Integrated Rotation.csv")
print('complete')